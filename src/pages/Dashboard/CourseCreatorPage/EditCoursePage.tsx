            ...
            if (typeof parsed === "string") {
              ...
              if (response?.data?.cover_location) {
                ...
                setChapters([
                  {
                    title: "Cover Image",
                    content: `<img src="${response?.data?.cover_location}" />`,
                  },
                  ...again,
                ]);
              ...
              if (typeof again[0] === "string") {
                ...
                if (again[0].includes("<h2>Exercises</h2>")) {
                  const cleanedChapter = again[0].replace(
                    /<h2>Exercises<\/h2>[\s\S]*$/,
                    ""
                  );
    ...
    if (chapter.includes("<h1")) {
      ...
      if (typeof chapter === "string") {
        if (chapter.includes("<h2>Exercises</h2>")) {
          const cleanedChapter = chapter.replace(
            /<h2>Exercises<\/h2>[\s\S]*$/,
            ""
          );
          setSelectedChapter(cleanedChapter);
    ...
    <React.Fragment>
      ...
      <div className="flex flex-col p-2 md:p-4 gap-4 lg:gap-6 max-w-full overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-16 md:mb-0">
          ...
          <div className={`p-2 sm:p-4 md:p-6 bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 ease-in-out w-full 
